...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_webgl_utils__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shaders_julia_vertex_glsl__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shaders_julia_fragment_glsl__ = __webpack_require__(8);
...
class Axes {
  constructor ({center, xLength, yLength, distanceToPixelRatio}) {
    ...
    this.svgContainer = __WEBPACK_IMPORTED_MODULE_0_d3__["select"]('#axes')
      .append('svg')
        .attr('width', '100%')
        .attr('height', '100%')

    this.xScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]()
      .domain([xMin, xMax])
      .range([padding, width - padding])

    this.xAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["axisTop"]()
      .tickPadding(6)
      .tickSize(6)
      .scale(this.xScale)
    ...
    this.yScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]()
      .domain([yMin, yMax])
      .range([height - padding, padding])

    this.yAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["axisRight"]()
      .tickPadding(6)
      .tickSize(6)
      .scale(this.yScale)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_Debouncer__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Axes__ = __webpack_require__(2);
...
const debouncedRender = new __WEBPACK_IMPORTED_MODULE_2__utils_Debouncer__["a" /* default */](() => {
  julia.render()
  axes.render({
    center: julia.complexCenter,
    xLength: julia.xLength,
